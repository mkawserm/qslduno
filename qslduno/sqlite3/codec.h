...
static int GLOBAL_CODEC_TYPE = 1;
...
typedef struct _Codec
{
  int           m_isEncrypted;
  int           m_hasReadKey;
  unsigned char m_readKey[MAX_KEYLENGTH];
  int           m_hasWriteKey;
  unsigned char m_writeKey[MAX_KEYLENGTH];
  Rijndael*     m_aes;
...
void CodecAES(Codec* codec, int page, int encrypt, unsigned char encryptionKey[MAX_KEYLENGTH],
